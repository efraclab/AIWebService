...
namespace AIWebservice.Controllers.LimsController
{
    [ApiController]
    [Route("api/lims")]
    [EnableRateLimiting("claude_api")]
    [Produces("application/json")]
    public sealed class LimsController : ControllerBase
    {
        private readonly LimsProcessingService _processor;
        private readonly PromptTemplateService _templates;
        private readonly ILogger<LimsController> _logger;

        public LimsController(
            LimsProcessingService processor,
            PromptTemplateService templates,
            ILogger<LimsController> logger)
        {
        ...
        [HttpPost("process")]
        [ProducesResponseType(typeof(LimsResponse), StatusCodes.Status200OK)]
            ...
            CancellationToken ct)
        {
            ...
            async Task<BatchItemResult> ProcessSingleBatchItem(LimsRequest req)
            {
    ...
    {
        [Required]
        public IReadOnlyList<LimsRequest>? Requests { get; init; }
    }
    ...
    public sealed class BatchItemResult
    {
        ...
        public LimsResponse? Response { get; init; }
