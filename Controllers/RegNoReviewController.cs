...
namespace AIWebservice.Controllers
{
    ...
    public sealed class RegNoReviewController : ControllerBase
    {
        ...
        public RegNoReviewController(RegNoReviewService service, ILogger<RegNoReviewController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> GetAuditLogs([FromBody] AuditLogRequest request, CancellationToken ct)
        {
